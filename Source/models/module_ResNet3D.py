# -*- coding: utf-8 -*-
"""
Implementation of the 3D ResNet architecture.
...
class module_ResNet3D(nn.Module):
    ...
    def __init__(self, patch_size, in_channels, out_channels, feat_channels=16, out_activation='sigmoid', layer_norm='none', **kwargs):
        ...
        self.out = nn.Sequential(
            ...
            nn.Conv3d(feat_channels*8, feat_channels*8, kernel_size=3, padding=1),
            self.norm_methods[self.layer_norm](feat_channels*8),
            nn.Conv3d(feat_channels*8, out_channels, kernel_size=1),
